<template>
    ...
    <el-card class="box-card" shadow="never">
        <div slot="header" class="clearfix" style="color: #FA7F64;font-size: 16px;">
            <i class="icon iconfont icon-dongman" style="font-size: 18px"></i>
        ...
        <el-row :gutter="20" style="text-align: center">
            ...
            <el-col :span="4" class="pic" v-for="(v,k) in videodata" :key="v.vod_id">
                <router-link  :to="'/detail/'+v.vod_id" tag="li">
                    ...
                    <span style="display: block;font-size: 14px;margin: 10px" class="text-overflow">{{v.vod_name}}</span>
    ...
    export default {
        ...
        computed:{
            videodata:function(){
                ...
                return store.state.dongman;
            }
        },
        created:function(){
            store.dispatch("getDongMan");
        }
    }
</script>
<style>
